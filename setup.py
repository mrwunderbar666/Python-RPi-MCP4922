...
setup(
    name="rpi-mcp4922",
    version="1.0.0",
    author="AymericFerreira",
    author_email="aymeric.ferreira@gmail.com",
    maintainer="AymericFerreira",
    maintainer_email="aymeric.ferreira@gmail.com",
    description="Python Library for driving MCP4922 DAC on Raspberry Pi, just a setup around MrWunderBar666",
